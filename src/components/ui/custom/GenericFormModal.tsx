...
export default function GenericFormModal({
    ...
    const handleSaveClick = async () => {
        try {
            ...
            console.error("A submissão falhou, o modal permanecerá aberto.", error);
        }
    }
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="bg-slate-900 border-2 border-purple-800/50 rounded-xl shadow-lg shadow-purple-500/20 text-slate-200 sm:max-w-md">
                <form onSubmit={(e) => { e.preventDefault(); handleSaveClick(); }}>
                    <DialogHeader className="text-center border-b border-purple-800/30 pb-4">
